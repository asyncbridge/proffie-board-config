...
This is my proffie board config file based on ProffieOS v7.7 for custom lightsaber using KR Saber hilt.
...
- https://www.krsabers.com/
- https://thesaberarmory.com/collections/diy-empty-hilts/products/kr-x-or-eco-hero-rotj-diy-empty-hilt-kit
